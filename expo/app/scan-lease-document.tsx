...
export default function ScanLeaseDocumentScreen() {
  const {
    properties,
    leaseFolders,
    addLeaseFolder,
  ...
  const handleExtractText = async (imageUri: string) => {
    try {
      ...
      Alert.alert('OCR Error', 'Failed to extract text from image. You can still save the document manually.');
    } finally {
  ...
  const handleSave = async () => {
    ...
    try {
      const document: LeaseDocument = {
        ...
        originalImageUri: capturedImage || undefined,
        createdAt: new Date().toISOString(),
        ...
        {!capturedImage ? (
          <View style={styles.captureSection}>
            ...
            <Text style={styles.sectionDescription}>
              Take a photo or select an image of your lease document to extract text automatically.
            </Text>
          ...
          <View style={styles.extractionSection}>
            ...
            {isExtracting ? (
              <View style={styles.extractingContainer}>
                ...
                <Text style={styles.extractingText}>Extracting text from image...</Text>
              </View>
            ) : (
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              {DOCUMENT_TYPES.map(type => (
                <TouchableOpacity
                  ...
                  onPress={() => setDocumentType(type.value as 'lease' | 'communication' | 'notice' | 'other')}
                >
                  <Text style={[
                    styles.typeChipText,
